...
const pageData = {
  ...
  sourceLink:
    'https://github.com/patternfly/patternfly-react/blob/main/packages/module/patternfly-docs/content/extensions/patternfly-extension-seed/examples/basic.md',
  propComponents: [
    {
      name: 'ExtendedButton',
      description: '',
...
const Component = () => (
  <React.Fragment>
    <AutoLinkHeader {...{ id: 'basic-usage', size: 'h2', className: 'ws-title ws-h2' }}>{`Basic usage`}</AutoLinkHeader>
