module.exports = {
  '/extensions/patternfly-extension-seed/design-guidelines': {
    ...
    Component: () =>
      import(
        /* webpackChunkName: "extensions/patternfly-extension-seed/design-guidelines/index" */ './extensions/patternfly-extension-seed/design-guidelines'
      )
  },
  '/extensions/patternfly-extension-seed/react': {
    ...
    Component: () =>
      import(
        /* webpackChunkName: "extensions/patternfly-extension-seed/react/index" */ './extensions/patternfly-extension-seed/react'
      )
  }
};
